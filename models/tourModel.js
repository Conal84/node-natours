...
const tourSchema = new mongoose.Schema(
  {
    ...
    // Embedded documents are added in arrays
    locations: [
      {
        type: {
          type: String,
  ...
  // Ensure virtual properties show up in output
  {
...
// Query Middleware
// populate the referenced guides data for every tour query that begins with 'find'
...
// the value of this is the document to be saved
